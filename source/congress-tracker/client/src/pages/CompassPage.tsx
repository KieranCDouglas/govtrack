  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      >
        ...
        Ideology scores are generated from a structured prompt containing each member's full voting
        record, sponsored and cosponsored legislation, committee assignments, interest-group ratings,
        and top PAC donor industries. Scores are calibrated against eight human-defined anchor members
        spanning the full ideological range, then equalized to spread the distribution across the
        complete scale. The <strong className="text-foreground">economic axis</strong> measures the
        preferred economic role of government, ranging from active intervention to a minimal,
